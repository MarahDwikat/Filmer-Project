        ...
        <div class="inner-box">
                        ...
                        <button style="background-color: transparent;border: none" type="submit" name="send">     <svg type="submit"class="sign" name="send" viewBox="200 100 1000 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g id="rectSent" clip-path="url(#clipPath)">
                                    <g id="rectSentItems">
                                        ...
                                        <text id="txtSent" fill="#3D0000" xml:space="preserve" style="white-space: pre" font-family="Roboto" font-size="82" font-weight="bold" letter-spacing="0.025em"><tspan x="637.487" y="568.027">Sent</tspan></text>
                                    </g>
                                </g>
            ...
            <div class="carousel" id="c">
                ...
                <div class="contact-info">
                    ...
                    <p>ibtisamkharrosheh@gmail.com</p>
                </div>
            </div>
