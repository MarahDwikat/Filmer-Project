...
<div class="login__content">
    ...
    <form action="insert.php" class="login__create " id="login-up" method="POST" style="border-radius: 20px; overflow-y: auto;    overflow-x: hidden; width: 600px; height: 720px" >
        ...
        <div class="login__box">
            ...
            <input type="number" placeholder="id of film" class="login__input" name="id" required>

        </div>
        <div class="login__box">
            <i class='bx bx-movie' ></i>
            <!-- class='bx bx-user login__icon'></>-->
            <input type="text" placeholder="FileName" class="login__input" name="FileName" required>
    ...
    padding-top: 22px;">
            ...
            <input id="file1" name="file1" type="file" accept="video/mp4, video/webm, video/ogg">
        </div>
