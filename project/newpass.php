...
<div class="form-container" style="margin-top: 200px; width: 850px; height: 470px; border-radius: 30px;  background: linear-gradient(45deg, #888888, #888888, #505f75); ">
    ...
    <form action="" method="POST" style="width: 270px; margin-left: 50px">
        <h2 style="margin-top: 0px; margin-bottom: 70px; color: #3d0000; ">UPDATE Password</h2>
        <div class="input-group" style="margin-top: 50px">
            <label for="new-password" style="font-size: 23px; color: #3d0000;">New Password</label>
            <input type="password" id="new-password" name="new-password" required>
        </div>
        <div class="input-group">
            <label for="confirm-password" style="font-size: 23px; color: #3d0000;">Confirm Password</label>
            <input type="password" id="confirm-password" name="confirm-password" required>
        </div>
        <button type="submit" name="update" style="margin-left: 60px;margin-top: 7px; background: linear-gradient(45deg, #1f5662, #3d0000, #505f75); ">Save Changes</button>
    </form>
