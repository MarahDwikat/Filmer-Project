...
<section class="movies" id="movies">
    <h2 class="heading">My Faviorat</h2>
    <?php
    include "../backend/conniction.php";
    $id = 1;
    $query = "SELECT movie.id , movie.imageurl , movie.year , movie.name , category.name FROM movie JOIN faviorat ON movie.id = faviorat.m_id JOIN category ON category.id = movie.cat_id WHERE faviorat.u_id=".$id;
